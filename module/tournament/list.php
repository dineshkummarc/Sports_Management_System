          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of Tournament(s)</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="tbltourna" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>#</th>
                    <th>Tournament ID</th>
        ...
        <form action="controller.php?action=add" enctype="multipart/form-data" method="POST">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add new Tournament</h4>
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                       <label for="name"  class="col-form-label col-form-label-sm">Tournament Type</label>
                        <input type="text" class="form-control form-control-sm" name="TOURTYPE" placeholder="Enter Tournament Type" required>
                      </div>
                    </div>
                  </div>
                <!-- /.card-body -->
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                       <label for="name"  class="col-form-label col-form-label-sm">Display Name</label>
                        ...
                        id="FULLNAME" placeholder="Enter Tournament Name">
                      </div>
                    </div>
