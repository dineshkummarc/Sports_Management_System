              ...
              <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                       <label for="name"  class="col-form-label col-form-label-sm">Category Type</label>
                        <input type="text" class="form-control form-control-sm" name="CATEGORYTYPE" placeholder="Enter Category" required>
                      </div>
                    </div>
                  </div>
                <!-- /.card-body -->
            ...
            <div class="modal-body">
              ...
              <div class="row">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                       <label for="name"  class="col-form-label col-form-label-sm">Category Type</label>
                        <input type="text" class="form-control form-control-sm" id="CATEGORYTYPE" name="CATEGORYTYPE" placeholder="Enter Category" required>
                      </div>
                    </div>
