    ...
    <div class="card-body">
    <h1>Double Elimination Matches:</h1>
 ...
 foreach($results AS $resultt){
    ...
    echo '<td class="bg-gray">'.$resultt->BRACKETTYPE.'</td>';
    ...
    echo '<td class="bg-orange">'.$resultt->BRACKETTYPE.'</td>';
    ...
    echo '<td class="bg-success">'.$resultt->BRACKETTYPE.'</td>';
...
/*echo '<td>';
                          ...
                          echo '<td><button type="button" class="btn btn-sm btn-success fa fa-edit fw-fa" data-toggle="modal" data-target="#modal-success'.$resultt->SMATCHID.'">Add Schedule</button></td>';
                        }
                          ?>
                          <div class="modal fade" id="modal-success<?php echo $resultt->SMATCHID;?>">
        <div class="modal-dialog">
          ...
          <form action="#" method="POST">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="submit" name="saveSingle" class="btn btn-outline-light">Save changes</button>
            </div>
          </form>
          </div>
          <!-- /.modal-content -->
