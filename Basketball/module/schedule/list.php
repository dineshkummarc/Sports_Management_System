          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of Schedule(s)</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="tblsched" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>#</th>
                    <th>Match Code</th>
...
<!-----START of Add Form---->
     <div class="modal fade" id="AddNewEntry">
        ...
        <form action="index.php?view=addmatch" enctype="multipart/form-data" method="POST">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                       <label for="name"  class="col-form-label col-form-label-sm">Tournament Type</label>
                        <select class="form-control form-control-sm" name="TOURID">
                         <?php
                            $tournament = new Tournament();
                            $tour = $tournament->listOfTournament();
                            foreach ($tour as $t) {
                              echo '<option value="'. $t->TOURID.'">'.$t->TOURTYPE .'</option>';
                            }
                  ...
                  <div class="col-sm-12">
                      <div class="form-group">
                       <label for="name"  class="col-form-label col-form-label-sm">Tournament Name</label>
                       <input type="text" name="TOURNAME" class="form-control" placeholder="Enter Tournament Name" required>
                     </div>
                   </div>
                 </div>
                <!-- /.card-body -->
